...
func LogInterceptor(logger *zap.Logger) (grpc.UnaryServerInterceptor, grpc.StreamServerInterceptor) {
	...
	return grpc_zap.UnaryServerInterceptor(logger, o...), grpc_zap.StreamServerInterceptor(logger, o...)
}
